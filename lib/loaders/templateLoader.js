...
const templateLoaderPath$1 = require('./tang/templateLoader')
...
module.exports = function (source) {
  ...
  // console.log()
  // this.emitFile(this.resourcePath.replace(/src\//, '').replace(process.cwd(), '') + '.wxml', JSON.stringify(compiler.compile(source)))
  // return ''
  templateLoaderPath$1.call(this, source)
